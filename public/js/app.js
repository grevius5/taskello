...
var open = 0;
var closed = 0;
var tag_selector; // Init all the functionality

$(document).ready(function () {
  // Get open and closed tasks
  get_open_tasks();
  get_closed_tasks();
  update_progress(); // Init the tag select component

  init_tags(); // Button click to show modal
...
function init_tags() {
  $.ajax({
    ...
    success: function success(response) {
      ...
      tag_selector = new slim_select__WEBPACK_IMPORTED_MODULE_0___default.a({
        select: ".tags",
        data: tags,
        placeholder: "Tags"
      });
...
function save_task(id) {
  // Close modal
  $("#add_modal").modal('hide'); // Ajax save data
...
function fill_task_list(list_parent) {
  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      $.each(response, function (index, obj) {
        var date_diff = Date.dateDiff('d', new Date(obj.created_at), new Date());
        list_parent.append("<div class=\"list-group-item\">\n                        <div class=\"d-flex w-100 justify-content-between\">\n                            <h5 class=\"mb-1\">".concat(obj.title, "</h5>\n                    ").concat(date_diff > 0 ? "<small>".concat(date_diff, " days ago</small>") : "<small>".concat(Date.dateDiff('h', new Date(obj.created_at), new Date()), " hours ago</small>"), "\n                        </div>\n                    ").concat(Object.keys(obj.tags).map(function (key) {
          return "<span class=\"badge mr-2 badge-primary ".concat(obj.tags[key].color, "\">").concat(obj.tags[key].title, "</span>");
        }).join(""), "\n                        <p class=\"mb-1\">").concat(obj.content, "</p>\n                        <small>").concat(Date.getFormatDate(obj.created_at), "</small>\n                        <div class=\"clearfix\">\n                            <div class=\"float-right\">\n                                <button value=\"").concat(obj.id, "\" class=\"btn btn-sm btn-outline-secondary view\">\n                                    <i class=\"fa fa-eye\"></i>\n                                </button>\n                    ").concat(is_closed ? "<button value=\"".concat(obj.id, "\" class=\"btn btn-sm btn-outline-primary uncheck\">\n                            <i class=\"fa fa-list\"></i>\n                        </button>") : "<button value=\"".concat(obj.id, "\" class=\"btn btn-sm btn-outline-info edit\">\n                            <i class=\"fa fa-pencil-alt\"></i>\n                        </button>\n                        <button value=\"").concat(obj.id, "\" class=\"btn btn-sm btn-outline-success check\">\n                            <i class=\"fa fa-check-circle\"></i>\n                        </button>"), "\n                                <button value=\"").concat(obj.id, "\" class=\"btn btn-sm btn-outline-danger remove\">\n                                    <i class=\"fa fa-trash\"></i>\n                                </button>\n                            </div>\n                        </div>\n                    </div>"));
      });
      update_progress();
    }
  });
  ...
  $.ajax({
    ...
    complete: function complete(response) {
      ...
      if (!has_error(data)) {
        ...
        tag_selector.set(tags); // Show modal
  ...
  $.ajax({
    ...
    complete: function complete(response) {
      ...
      if (!has_error(data)) {
        ...
        $.each(data.tags, function (index, obj) {
          $("#modal_show_tags").append("<span class=\"badge mr-2 badge-primary ".concat(obj.color, "\">").concat(obj.title, "</span>"));
        }); // Show modal
...
function has_error(data) {
  if (data["message"]) {
    $.each(data.errors, function (indexInArray, valueOfElement) {
      $("#error_area").append("<div class=\"alert fade show alert-warning\" role=\"alert\" id=\"alert_error\">\n                    <button type=\"button\" class=\"close\" aria-label=\"Close\" data-dismiss=\"alert\">\n                        <span aria-hidden=\"true\">&times;</span>\n                    </button>\n                    <strong>".concat(indexInArray, ":</strong> ").concat(valueOfElement, "\n                </div>"));
    });
    setTimeout(function () {
      $(".alert").alert("close");
    }, 5000);
...
function show_modal_tags() {
  $.ajax({
    ...
    success: function success(response) {
      ...
      $("#modal_tags_body").append("<table class=\"table table-light\">\n                <tbody>\n                ".concat(Object.keys(response).map(function (key) {
        return "<tr>\n                        <td class=\"w-75\">\n                            <input class=\"form-control\" type=\"text\" name=\"\" value=\"".concat(response[key].title, "\" id=\"tag_title_").concat(response[key].id, "\">\n                        </td>\n                        <td class=\"w-25 mx-2 my-2\">\n                            <button type=\"\" button class=\"btn w-100 ").concat(response[key].color, "\"></button>\n                        </td>\n                        <td>\n                            <button type=\"button\" class=\"btn btn-sm btn-outline-success tag\" value=\"").concat(response[key].id, "\">\n                                <i class=\"fa fa-save\"></i>\n                            </button>\n                        </td>\n                    </tr>");
      }).join(""), "\n                </tbody>\n            </table>\n            "));
      $("#modal_tags").modal();
    }
  });
  ...
  $.ajax({
    ...
    complete: function complete(response) {
      ...
      if (!has_error(data)) {
        // Update tasks
        get_open_tasks();
        get_closed_tasks(); // update tags list

        tag_selector.destroy();
        init_tags(); // close modal
...
__webpack_require__(/*! /mnt/Tera/github/s2i_Taskello/taskello/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /mnt/Tera/github/s2i_Taskello/taskello/resources/sass/app.scss */"./resources/sass/app.scss");
